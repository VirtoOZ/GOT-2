 ...
 */
    ...
    class Header extends react.Component {
        ...
        render() {
            return react.createElement("header", {
            ...
            }, react.createElement("span", null)), react.createElement("nav", {
                ...
                to: "/characters",
                onClick: () => null
            }, "Characters")), react.createElement("li", {
                className: "menu__item"
            }, react.createElement(Link, {
                className: "menu__link",
                to: "/books",
                ...
                to: "/houses",
                onClick: () => null
            }, "Houses")))))), react.createElement("div", {
    ...
    class GotService {
        ...
        getResurce=async url => {
            ...
            if (!result.ok) throw new Error(`Coud not fetch: ${url}, status: ${result.status}`);
            return result.json();
        };
    ...
    function ErrorMessage() {
        return react.createElement(react.Fragment, null, react.createElement("img", {
            ...
            src: "img/errorMessage/Daineris-Else.webp",
            alt: "error-img"
        }), react.createElement("div", {
    ...
    class RandChar extends react.Component {
        ...
        updateCharacter=() => {
            ...
            this.gotService.getCharacter(id).then(this.updateData).catch(this.onError);
        };
        updateData=data => {
            this.setState({
                data,
        ...
        render() {
            ...
            const content = !(loading || error) ? react.createElement(View, {
                data,
                id
            }) : null;
            ...
            return react.createElement("section", {
                ...
                className: "random-char__container"
            }, react.createElement("ul", {
                className: "random-char__list list"
    ...
    const View = ({data, id}) => {
        ...
        return react.createElement(react.Fragment, null, react.createElement("li", {
            className: "random-char__title list__title"
        }, react.createElement("span", {
            className: "random-char__label list__label"
        }, "Random Character: "), react.createElement("span", {
            className: "random-char__value list__value"
        }, name, " (id:", id, ")")), react.createElement("li", {
            className: "random-char__item list__item"
        }, react.createElement("span", {
            className: "random-char__label list__label"
    ...
    function ItemList({getData, onItemSelected}) {
        ...
        return react.createElement("section", {
            ...
            className: "list-char__list list"
        }, items));
    }
    const SectionBox = ({children}) => react.createElement("div", {
    ...
    const BookPage = () => {
        ...
        return react.createElement(sectionBox, null, react.createElement(ItemList, {
    ...
    const Field = ({item, field, label}) => react.createElement("li", {
        className: "detales-char__title list__item"
    }, react.createElement("span", {
        className: "detales-char__label list__label"
    }, label), react.createElement("span", {
        className: "detales-char__value list__value"
    }, item[field]));
    function DetalesItem({itemId, getData, children}) {
        const [item, setItem] = (0, react.useState)(itemId);
        if (!itemId) return react.createElement("section", {
            className: "detales-char detales-char__section page__section"
        }, react.createElement("div", {
            className: "detales-char__list list"
        }, react.createElement("span", {
            className: ""
        ...
        }, item.name), react.Children.map(children, (child => react.cloneElement(child, {
            item
        })))));
    }
    const detalesItem_detalesItem = DetalesItem;
    const RowBlock = ({left, right}) => react.createElement(react.Fragment, null, left, right);
    ...
    class HousePage extends react.Component {
        ...
        render() {
            if (this.state.error) return react.createElement(errormessage, null);
            const {selectedHouse} = this.state;
            const itemList = react.createElement(ItemList, {
                onItemSelected: this.onItemSelected,
                getData: this.gotService.getAllHouses
            });
            const detalesItem = react.createElement(detalesItem_detalesItem, {
            ...
            return react.createElement(sectionBox, null, react.createElement(rowBlock, {
                left: itemList,
                right: detalesItem
            }));
        }
    ...
    const BooksItem = () => {
        const gotService = new GotService;
        const [selectedBook, setSelectedBook] = (0, react.useState)(1);
        return react.createElement(sectionBox, null, react.createElement(detalesItem_detalesItem, {
            itemId: selectedBook,
    ...
    const App = () => {
        ...
        new GotService;
        if (error) return react.createElement(errormessage, null);
        const randomBlock = onHide ? react.createElement(react.Fragment, null) : react.createElement(RandChar, null);
        return react.createElement(BrowserRouter, null, react.createElement("div", {
            ...
            className: "page"
        }, randomBlock, react.createElement("div", {
            ...
            path: "/houses/",
            element: react.createElement(HousePage, null)
        }), react.createElement(Route, {
            path: "/books/",
            element: react.createElement(bookPage, null)
        }), react.createElement(Route, {
            path: "/books/:id",
            element: react.createElement(booksItem, {
                bookId: params.id
            })
        })), react.createElement("div", {
            className: "page__bg"
        }, react.createElement("img", {
            src: "img/app/got.webp",
            alt: "bg"
        })))));
    };
    const app = App;
